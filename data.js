const dataViews = {
    ...
    renderDataDashboard() {
        ...
        return `<div class="max-w-[1400px] mx-auto">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <div class="bg-white border border-slate-200 rounded shadow-sm overflow-hidden">
                    <div class="px-4 py-3 border-b border-slate-200 bg-slate-50"><h3 class="text-[13px] font-bold text-slate-800"><i class="fa-solid fa-ranking-star text-amber-500 mr-1.5"></i>고객사 자금흐름 순위 (30일)</h3></div>
    ...
    renderAsset() {
        ...
        return `<div class="max-w-[1400px] mx-auto">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                <div class="bg-white border border-slate-200 rounded p-5 shadow-sm">
                    <h3 class="font-bold text-slate-800 text-[14px] mb-1">금융기관별 자산 점유율</h3><p class="text-[11px] text-slate-500 mb-5">예금+적금 합산 (억 원)</p>
                ...
                <div class="bg-white border border-slate-200 rounded p-5 flex flex-col shadow-sm max-h-[700px]">
                    <div class="flex justify-between items-center mb-4"><h3 class="font-bold text-slate-800 text-[14px]">만기 도래 타겟</h3><input type="text" id="asset-search" onkeyup="dataViews.filterAsset()" placeholder="고객사, 은행명 검색" class="border border-slate-300 rounded text-xs px-3 py-1 w-48 outline-none focus:border-teal-500 font-medium"></div>
        ...
        return `<div class="max-w-[1400px] mx-auto">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 mb-5">
                <div class="lg:col-span-5 bg-white border border-slate-200 rounded p-5 shadow-sm">
                    <h3 class="font-bold text-slate-800 text-[14px] mb-1">금융기관별 점유</h3><p class="text-[11px] text-slate-500 mb-5">정기예금 + 적금 합산</p>
                ...
                <div class="lg:col-span-7 bg-white border border-slate-200 rounded p-5 shadow-sm">
                    <h3 class="font-bold text-slate-800 text-[14px] mb-4">은행별 만기 도래 분석</h3>
            ...
            <div class="bg-white border border-slate-200 rounded shadow-sm overflow-hidden">
                <div class="px-4 py-3 border-b border-slate-200 bg-slate-50 flex justify-between items-center"><h3 class="text-[14px] font-bold text-slate-800"><i class="fa-solid fa-building mr-1.5 text-teal-600"></i>고객사별 예적금 보유 현황</h3>
